...
class Poll {
	constructor(opt) {
		...
		this.footNote += `${opt.notes ? '| ' : ''}Ceci est le sondage #${this.id}. Il expirera dans ${this.timeout} minutes.`;
...
client.login('Nzg3ODExOTE5NDg2NTE3Mjk5.X9aZBg.jF-RGeEGuA0PZGtlxZbJcq9f0MQ');